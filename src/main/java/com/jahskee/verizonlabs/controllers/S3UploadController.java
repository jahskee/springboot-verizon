 ...
 */
   ...
   // final static String AWS_SECRET_KEY = System.getenv("AWS_SECRET_KEY");
    final static String AWS_SECRET_KEY = "yix4Yaph8nwIv9z2/bSXT8mDC2HJsf7XV2WjmccI";
    ...
    @PostMapping("/s3/signature")
    public void postSignatureRequest(HttpServletRequest req, HttpServletResponse resp) throws IOException {        
    	 handleSignatureRequest(req, resp);    
    }
    
    @PostMapping("/s3/uploadsuccess")
    public void postUploadSucessRequest(HttpServletRequest req, HttpServletResponse resp) throws IOException  {
     
            handleUploadSuccessRequest(req, resp);
    }

    // Main entry point for DELETE requests sent by Fine Uploader.
    @PostMapping("/s3/dodelete")
    public void doDelete(HttpServletRequest req, HttpServletResponse resp) throws IOException
    {
        ...
        AWSCredentials myCredentials = new BasicAWSCredentials("AKIAJLRYC5FTY3VRRTDA", "yix4Yaph8nwIv9z2/bSXT8mDC2HJsf7XV2WjmccI");
